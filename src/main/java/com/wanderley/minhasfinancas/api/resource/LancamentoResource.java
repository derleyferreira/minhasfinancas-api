...
import com.wanderley.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.wanderley.minhasfinancas.api.dto.LancamentoDTO;
...
public class LancamentoResource {
	...
	public ResponseEntity atualizarStatus(@PathVariable("id") Long id, @RequestBody AtualizaStatusDTO dto ) {
		...
		return service.obterPorId(id).map(entity -> {
			...
			if (statusSelecionado == null) {
				return ResponseEntity.badRequest().body("Status de lançamento inválido");
			}
	...
	private Lancamento converter(LancamentoDTO dto) {
		...
		Lancamento lancamento =  Lancamento.builder().Id(dto.getId())
		...
		Usuario usuario = usuarioService.obterPorId(dto.getUsuario())
				                        .orElseThrow( ()-> new RegraNegocioException("Usuário não encontrado para o código informado.") );
